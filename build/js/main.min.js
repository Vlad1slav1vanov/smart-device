...
/* harmony import */ var _modules_form_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form-scroll */ "./js/modules/form-scroll.js");
/* harmony import */ var _modules_open_more__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/open-more */ "./js/modules/open-more.js");
/* harmony import */ var _modules_change_content__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/change-content */ "./js/modules/change-content.js");
/* harmony import */ var _modules_checkbox__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/checkbox */ "./js/modules/checkbox.js");
/* harmony import */ var _modules_no_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/no-js */ "./js/modules/no-js.js");
/* harmony import */ var _modules_phone_input_valid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/phone-input-valid */ "./js/modules/phone-input-valid.js");
/* harmony import */ var _modules_form_focus__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/form-focus */ "./js/modules/form-focus.js");
/* harmony import */ var _modules_nav_section__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/nav-section */ "./js/modules/nav-section.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["accordionsToggle"])();
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_4__["popupEvent"])();
  Object(_modules_open_more__WEBPACK_IMPORTED_MODULE_6__["addToggleDescriptionEvt"])();
  Object(_modules_change_content__WEBPACK_IMPORTED_MODULE_7__["addChangeTextEvt"])();
  Object(_modules_form_scroll__WEBPACK_IMPORTED_MODULE_5__["scrollToFormAddEvent"])();
  Object(_modules_checkbox__WEBPACK_IMPORTED_MODULE_8__["addCheckboxEvt"])();
  Object(_modules_phone_input_valid__WEBPACK_IMPORTED_MODULE_10__["addPhoneValids"])();
  Object(_modules_no_js__WEBPACK_IMPORTED_MODULE_9__["noJsOff"])();
  Object(_modules_form_focus__WEBPACK_IMPORTED_MODULE_11__["focusEvt"])();
  Object(_modules_nav_section__WEBPACK_IMPORTED_MODULE_12__["navItemsCheck"])();
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: accordionsToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordionsToggle", function() { return accordionsToggle; });
var openNavButton = document.querySelector(".nav-section__button-plus");
var openContactsButton = document.querySelector(".contacts-section__button-plus");
var navTitleField = document.querySelector(".nav-section__title-wrapper");
var contactsList = document.querySelector(".contacts-section__list");
var navigation = document.querySelector(".nav-section__navigation");
var contactsTitleField = document.querySelector(".contacts-section__title-wrapper");
var toggleContactsList = function toggleContactsList() {
...
var accordionsToggle = function accordionsToggle() {
...
/*!**************************************!*\
  !*** ./js/modules/change-content.js ***!
  \**************************************/
/*! exports provided: addChangeTextEvt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addChangeTextEvt", function() { return addChangeTextEvt; });
var mobileScreen = window.matchMedia("(max-width: 767px)");
var tabletScreen = window.matchMedia("(min-width: 768px) and (max-width: 1023px)");
var desktopScreen = window.matchMedia("(min-width: 1024px)");
var consultButton = document.querySelector(".main-description__button");
var productsTitle = document.querySelector(".products__title");
var providersDescription = document.querySelector(".about-company__providers-description");
...
var addChangeTextEvt = function addChangeTextEvt() {
...
/*!********************************!*\
  !*** ./js/modules/checkbox.js ***!
  \********************************/
/*! exports provided: addCheckboxEvt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addCheckboxEvt", function() { return addCheckboxEvt; });
var formCheckbox = document.getElementById("form-checkbox");
var popupCheckbox = document.getElementById("popup-checkbox");
var accessCheckbox = document.getElementById("access-checkbox");
var popupAccessCheckbox = document.getElementById("popup-access-checkbox");
var addCheckboxEvt = function addCheckboxEvt() {
...
/***/ "./js/modules/form-focus.js":
/*!**********************************!*\
  !*** ./js/modules/form-focus.js ***!
  \**********************************/
/*! exports provided: focusEvt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "focusEvt", function() { return focusEvt; });
var question = document.getElementById("question-textarea");
var name = document.getElementById("name-input");
var phone = document.getElementById("phone-input");
var checkbox = document.getElementById("access-checkbox");
var submitButton = document.getElementById("submit-form");
var focusEvt = function focusEvt() {
...
/*!***********************************!*\
  !*** ./js/modules/form-scroll.js ***!
  \***********************************/
/*! exports provided: scrollToFormAddEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollToFormAddEvent", function() { return scrollToFormAddEvent; });
var formScrollButton = document.querySelector(".main-description__button");
...
var scrollToFormAddEvent = function scrollToFormAddEvent() {
...
/***/ "./js/modules/nav-section.js":
/*!***********************************!*\
  !*** ./js/modules/nav-section.js ***!
  \***********************************/
/*! exports provided: navItemsCheck */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "navItemsCheck", function() { return navItemsCheck; });
var navItems = document.querySelectorAll('.nav-section__item');
var navList = document.querySelector('.nav-section__list');
var desktopScreen = window.matchMedia("(min-width: 1024px)");
var navItemsCheck = function navItemsCheck() {
  if (navItems.length > 8 && desktopScreen.matches) {
    navList.style.height = "".concat(navItems.length * 35 / 2, "px");
  }
};
...
/*!*****************************!*\
  !*** ./js/modules/no-js.js ***!
  \*****************************/
/*! exports provided: noJsOff */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "noJsOff", function() { return noJsOff; });
var noJsBlocks = document.querySelectorAll(".no-js");
var noJsOff = function noJsOff() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addToggleDescriptionEvt", function() { return addToggleDescriptionEvt; });
var openMoreButton = document.querySelector(".about-company__button-more");
var moreDescriptionBlock = document.querySelector(".about-company__more-description");
var toggleDescription = function toggleDescription() {
  ...
  openMoreButton.classList.contains("about-company__button-more--is-open") ? openMoreButton.textContent = "Свернуть" : openMoreButton.textContent = "Подробнее";
};
var addToggleDescriptionEvt = function addToggleDescriptionEvt() {
...
/*!*****************************************!*\
  !*** ./js/modules/phone-input-valid.js ***!
  \*****************************************/
/*! exports provided: addPhoneValids */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addPhoneValids", function() { return addPhoneValids; });
...
var pagePhoneParent = document.getElementById("feedback-form-phone-parent");
var pagePhoneInput = document.getElementById("phone-input");
var popupPhoneParent = document.getElementById("parent-phone-input-popup");
var popupPhoneInput = document.getElementById("popup-phone-input");
var popupForm = document.getElementById("feedback-form-popup");
var pageForm = document.getElementById("feedback-form-page");
var addPhoneValids = function addPhoneValids() {
  Object(_form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_0__["initPhoneInput"])(pagePhoneParent);
  Object(_form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_0__["initPhoneInput"])(popupPhoneParent);
  popupForm.addEventListener("submit", function (evt) {
    var isValid = validator._validatePhoneInput(popupPhoneParent, popupPhoneInput);
    if (!isValid) {
      evt.preventDefault();
...
/*!*****************************!*\
  !*** ./js/modules/popup.js ***!
  \*****************************/
/*! exports provided: popupEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popupEvent", function() { return popupEvent; });
var openPopupButton = document.querySelector(".header__open-popup-btn");
...
var focusedElementBeforePopup = document.activeElement;
var firstElement = document.getElementById("popup-name-input");
var popupQuestion = document.getElementById("popup-question-textarea");
var popupName = document.getElementById("popup-name-input");
var popupPhone = document.getElementById("popup-phone-input");
var popupCheckbox = document.getElementById("popup-access-checkbox");
var popupSubmitButton = document.getElementById("submit-popup");
...
var focusTrap = function focusTrap() {
  var focusableEls = popupWrapper.querySelectorAll('a[href]:not([disabled]), button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled]), select:not([disabled])');
...
var popupEvent = function popupEvent() {
